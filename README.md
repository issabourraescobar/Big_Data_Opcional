...
Para la realización de una estadística descriptiva, se trabajará con el comando summary(Datos_Nomofobia), arrojando la media, mediana, moda y percentiles de las
...
se cumpliría con la normalidad. Si bien la mayoría de las variables cumplen con dicho requisito, esto no ocurre con la variable "Habilidades Blandas".
...
Es sabido para que el comportamiento de los errores sea normal, este debe tener su simetría cercana a 0, en este caso la variable "Habilidades Blandas" no cumple con el requisito.
...
Al analizar los coeficiente, se llega a la conclusión que: mientras mayor sea el estrés, mayor es la posibilidad de sufrir de nomofobia, lo mismo ocurre con
...
uno esperaría que su signo fuera negativo, tal como ocurre con resolución de conflicto y edad, en donde, mas alto sea su coeficiente menor es la probabilidad
...
Analizando el valor p de cada variable, refleja que "Habilidades Blandas", "Resolución de conflictos", "Genero" y "Edad" no son significativos, al no ser menor a 0,05.
...
barplot(Datos_Nomofobia$Estrés): tomamndo la variable estrés, posee un comportamiento uniforme.
